...
export default function UpdateUserForm(){
    ...
    <div className="flex gap-10 items-center">
            ...
            <label htmlFor="radioDefault2" className="inline-block text-gray-800">
             ...
             <button className="flex-justify-center text-md w-2/6 bg-yellow-400 text-white px-4 py-2 border rounded-md hover:bg-gray-50 hover:border-green-500 hover:text-green-500">Update
             </button> 
